...
UMAPPlot(obj)
SaveH5Seurat(obj, filename = "liver.h5Seurat")
Convert("liver.h5Seurat", dest = "h5ad")
rm(list = ls())

#Identify cell clusters

Convert("liver.h5ad", ".h5seurat")
liver <- LoadH5Seurat("liver.h5Seurat")
DimPlot(liver)
